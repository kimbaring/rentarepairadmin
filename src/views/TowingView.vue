<template>
    <SharedLayout>
    <div class="pagetitle">
      <h1>Towing Company</h1>
      <nav>
        <ol class="breadcrumb">
          <RouterLink class="breadcrumb-item" to="/dashboard">Home</RouterLink>
          <li class="breadcrumb-item">Employee</li>
          <li class="breadcrumb-item active">Towing Company</li>
    ...
    <div class="card">
        <div class="card-body">
            <p></p>
            <button type="button" class="btn btn-primary">Add Towing Member</button>
        </div>
    </div>
    <div class="card recent-sales overflow-auto">
        <div class="card-body">
          ...
          <div id="divRequest6">
            <table id="towingtable1" class="table tableborderless datatable" width="100%">
              <thead>
                    <tr>
                        <th scope="col">#</th>
